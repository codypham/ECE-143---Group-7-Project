...
def cluster_region(value='region'):
    '''
    This function creates region-based scatter-plot. It can also be used to create a cluster plot.
    Args:
        value (str): when the string equals to 'region', the function shows a region-based scatter-plot, when it equals to 'cluster', the function shows a cluster plot.
    '''
